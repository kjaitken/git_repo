...
#./outputs
  ...
  2. the infraction fees and street location for a user-selected infraction type (typed in when prompted), printed out and saved in the working directory as "parkgrep.csv"
...
A prompt will appear after the  
